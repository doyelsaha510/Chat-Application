    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnstatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(userProfile.this, statusactivity.class);
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(userProfile.this, "profile image upload successfully", Toast.LENGTH_SHORT).show();
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    databaseReference.child("image").setValue(Imageurl).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            {
                                                Toast.makeText(userProfile.this, "error"+task.getException().toString(), Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(userProfile.this, "error:" + msg, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
